...
def test_write_metadata():
    ...
    # Data files
    assert (
        data.get("files")[0]["description"] == pst_mdb.pst_metadata.files[0].description
    )
    ...
    # Weights files
    assert (
        data.get("files")[1]["description"] == pst_mdb.pst_metadata.files[1].description
    )
    ...
    assert (
        data.get("obscore")["calib_level"] == pst_mdb.pst_metadata.obscore.calib_level
    )
    ...
    assert (
        data.get("obscore")["target_name"] == pst_mdb.pst_metadata.obscore.target_name
    )
    ...
    assert (
        data.get("obscore")["t_resolution"] == pst_mdb.pst_metadata.obscore.t_resolution
    )
    ...
    assert (
        data.get("obscore")["em_res_power"] == pst_mdb.pst_metadata.obscore.em_res_power
    )
    assert (
